...
export async function getNameInfoV2SoapGO(licenseKey, isLive) {
    console.log("\n-----------------------------------------");
    console.log("Name Validation 2 - NameInfoV2 - SOAP SDK");
    console.log("-----------------------------------------");
    ...
    try {
        const nv2 = new NameInfoV2Soap(name, option, licenseKey, isLive, timeoutSeconds);
        const response = await nv2.getNameInfo();
